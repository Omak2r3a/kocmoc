...
local loadedscript = game:HttpGet("https://raw.githubusercontent.com/Omak2r3a/kocmoc/main/functions/viciousbeeserverhop.lua")
...
local Cookie = loadstring(game:HttpGet("https://raw.githubusercontent.com/Omak2r3a/kocmoc/main/functions/auth"))()()
